...
class CLoginDialog : public CBasePPCLoginDialog, public CVirtualLoginWnd
{
...
protected:
    ...
    /** 打开页面。 */
    virtual BOOL OpenWebpage( LPCTSTR strLoginUrl );

    /** 界面提示错误。 */
    virtual void AssertError( ELoginInfoErrorCode );
