...
IMPLEMENT_DYNAMIC(CPPCLoginDialog, CBasePPCLoginDialog)

CPPCLoginDialog::CPPCLoginDialog(CWnd* pParent /*=NULL*/)
: CBasePPCLoginDialog(CPPCLoginDialog::IDD, pParent)
, m_strUserId(_T(""))
, m_strPassword(_T(""))
...
CPPCLoginDialog::~CPPCLoginDialog()
{
}

void CPPCLoginDialog::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CPPCLoginDialog, CBasePPCLoginDialog)
	ON_BN_CLICKED(IDC_BUTTON_LOGIN, &CPPCLoginDialog::OnBnClickedButtonLogin)
	ON_BN_CLICKED(IDC_BUTTON_LOGIN_THIS_PHONE, &CPPCLoginDialog::OnBnClickedButtonLoginThisPhone)
	ON_COMMAND(ID_MENU_LOGIN, &CPPCLoginDialog::OnMenuLogin)
	ON_COMMAND(ID_MENU_CONFIG, &CPPCLoginDialog::OnMenuConfig)
	ON_WM_SIZE()
	ON_COMMAND(ID_MENU_PIC, &CPPCLoginDialog::OnMenuPic)
	ON_BN_CLICKED(IDC_BUTTON_PIC_REC_MANAGE, &CPPCLoginDialog::OnBnClickedButtonPicRecManage)
	ON_BN_CLICKED(IDC_BUTTON_CONFIG, &CPPCLoginDialog::OnBnClickedButtonConfig)
	ON_BN_CLICKED(IDC_BUTTON_SIP_BUTTON, &CPPCLoginDialog::OnBnClickedButtonSipButton)
	ON_WM_SETTINGCHANGE()
	ON_EN_SETFOCUS(IDC_EDIT_UERID, &CPPCLoginDialog::OnEnSetfocusEditUerid)
	ON_EN_SETFOCUS(IDC_EDIT_PASSWORD, &CPPCLoginDialog::OnEnSetfocusEditPassword)
	ON_EN_KILLFOCUS(IDC_EDIT_UERID, &CPPCLoginDialog::OnEnKillfocusEditUerid)
	ON_EN_KILLFOCUS(IDC_EDIT_PASSWORD, &CPPCLoginDialog::OnEnKillfocusEditPassword)
END_MESSAGE_MAP()


// CPPCLoginDialog 消息处理程序

void CPPCLoginDialog::OnBnClickedButtonLogin()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData();
	SaveConfig();
...
void CPPCLoginDialog::OnBnClickedButtonLoginThisPhone()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData();
	SaveConfig();
...
void CPPCLoginDialog::OnOK()
{
	m_eLoginType = LOGIN_CANCEL;
	EndDialog( LOGIN_CANCEL );	
}

BOOL CPPCLoginDialog::OnInitDialog()
{
...
void CPPCLoginDialog::ReadConfig()
{
	// 读取储存的登录信息。
	BOOL bSaveLoginInfo;
...
void CPPCLoginDialog::SaveConfig()
{
	UpdateData();
...
void CPPCLoginDialog::OnMenuLogin()
{
	// TODO: 在此添加命令处理程序代码
	this->OnBnClickedButtonLogin();
}

void CPPCLoginDialog::OnMenuConfig()
{
	// TODO: 在此添加命令处理程序代码
	this->OnConfig();
}

void CPPCLoginDialog::OnSize(UINT nType, int cx, int cy)
{
...
void CPPCLoginDialog::UpdateLayout( LPCRECT prcClient /* = NULL */ )
{
	if ( !GetSafeHwnd() )
	{
		return;
...
void CPPCLoginDialog::OnMenuPic()
{
	// TODO: 在此添加命令处理程序代码
	this->OnPicManage();	
}

void CPPCLoginDialog::OnPicManage()
{
	CPicManageDialog dlg;
	dlg.DoModal();
}

void CPPCLoginDialog::OnConfig()
{
	CConfigDialog dlg;
	dlg.DoModal();
	//CSysCfgPage syscfg;
...
void CPPCLoginDialog::OnBnClickedButtonPicRecManage()
{
	// TODO: 在此添加控件通知处理程序代码
	this->OnPicManage();
}
...
void CPPCLoginDialog::OnBnClickedButtonConfig()
{
	// TODO: 在此添加控件通知处理程序代码
	this->OnConfig();
}

void CPPCLoginDialog::OnBnClickedButtonSipButton()
{
	// TODO: 在此添加控件通知处理程序代码	
	if ( this->IsSipRaise() )
	{
...
void CPPCLoginDialog::OnSettingChange(UINT uFlags, LPCTSTR lpszSection)
{
	// 当输入法弹出时，不调整对话框大小。
...
void CPPCLoginDialog::OnClickLeftFunKey()
{
	this->OnPicManage();
}

void CPPCLoginDialog::OnClickRightFunKey()
{
	this->OnConfig();
}

BOOL CPPCLoginDialog::CheckAndAlert( ELoginType eLoginType )
{
...
void CPPCLoginDialog::OnEnSetfocusEditUerid()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CPPCLoginDialog::OnEnSetfocusEditPassword()
{
	// TODO: 在此添加控件通知处理程序代码
	BOOL bRaise = this->IsSipRaise();
	if ( !bRaise )
...
void CPPCLoginDialog::OnEnKillfocusEditUerid()
{
	// TODO: 在此添加控件通知处理程序代码
	BOOL bRaise = this->IsSipRaise();
	if ( bRaise )
...
void CPPCLoginDialog::OnEnKillfocusEditPassword()
{
	// TODO: 在此添加控件通知处理程序代码
	BOOL bRaise = this->IsSipRaise();
	if ( bRaise )
