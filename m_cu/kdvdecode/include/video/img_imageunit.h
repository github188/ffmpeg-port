...
#else
#ifdef KDIMG_EXPORTS
#define KDIMG_API __declspec(dllexport)
#else
#define KDIMG_API __declspec(dllimport)
#endif
#endif
...
====================================================================*/
KDIMG_API l32 ImageUnitGetVersion(void *pvVer, l32 l32BufLen, l32 *pl32VerLen, u32 u32ImageProcessType);
...
返回值说明  : 成功: VIDEO_SUCCESS, 失败: 返回错误码
====================================================================*/
KDIMG_API l32 ImageUnitOpen(void **ppvHandle, void *pvImageParam, void *pvMemParam, u32 u32IamgeProcessType);
...
返回值说明  : 成功: VIDEO_SUCCESS, 失败: 返回错误码
====================================================================*/
KDIMG_API l32 ImageUnitProcess(void *pvHandle, void *pvImageInput, void *pvImageOutput);
...
返回值说明  : 成功: VIDEO_SUCCESS, 失败: 返回错误码
====================================================================*/
KDIMG_API l32 ImageUnitSetParam(void *pvHandle, void *pvImageParam);
...
返回值说明  : 成功: VIDEO_SUCCESS, 失败: 返回错误码
====================================================================*/
KDIMG_API l32 ImageUnitDebug(void *pvHandle, void *pvDebugInfo);
...
返回值说明  : 成功: VIDEO_SUCCESS, 失败: 返回错误码
====================================================================*/
KDIMG_API l32 ImageUnitAnalyzeErrorCode(void *pvHandle, l32 l32ErrorCode, l32 l32BufLen, void *pvErrorCodeInfo);
...
返回值说明  : 成功: VIDEO_SUCCESS, 失败: 返回错误码
====================================================================*/
KDIMG_API l32 ImageUnitClose(void *pvHandle);
...
返回值说明  : 成功: VIDEO_SUCCESS, 失败: 返回错误码
====================================================================*/
KDIMG_API l32 ImageUnitGetStatus(void *pvHandle, void *pvImageParam);
